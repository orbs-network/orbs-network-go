...
func TestProcessCall_WithUnknownContractFails(t *testing.T) {
	test.WithContext(func(ctx context.Context) {
		...
		h.expectSdkCallMadeWithServiceCallMethod(deployments_systemcontract.CONTRACT_NAME, deployments_systemcontract.METHOD_GET_CODE, builders.ArgumentsArray(string(input.ContractName), uint32(0)), nil, errors.New("code not found error"))
...
func TestProcessCall_WithDeployableContractThatCompiles(t *testing.T) {
	test.WithContext(func(ctx context.Context) {
		...
		h.expectSdkCallMadeWithServiceCallMethod(deployments_systemcontract.CONTRACT_NAME, deployments_systemcontract.METHOD_GET_CODE, builders.ArgumentsArray(string(input.ContractName), uint32(0)), codeOutput, nil)
		h.expectSdkCallMadeWithServiceCallMethod(deployments_systemcontract.CONTRACT_NAME, deployments_systemcontract.METHOD_GET_CODE_PARTS, builders.ArgumentsArray(string(input.ContractName)), builders.ArgumentsArray(uint32(0)), nil)
