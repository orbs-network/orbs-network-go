...
var VOTE_MIRROR_PERIOD_LENGTH_IN_BLOCKS = uint64(160)
var VOTE_VALID_PERIOD_LENGTH_IN_BLOCKS = uint64(40320)
var ELECTION_PERIOD_LENGTH_IN_BLOCKS = uint64(5000)
var TRANSITION_PERIOD_LENGTH_IN_BLOCKS = uint64(1)
var FIRST_ELECTION_BLOCK = uint64(5273687)
var MAX_ELECTED_VALIDATORS = 22
var MIN_ELECTED_VALIDATORS = 5
