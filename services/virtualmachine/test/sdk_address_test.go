...
func TestSdkAddress_GetSignerAddressWithoutSignerFails(t *testing.T) {
	...
	h.expectNativeContractMethodCalled("Contract1", "method1", func(contextId primitives.ExecutionContextId, inputArgs *protocol.MethodArgumentArray) (protocol.ExecutionResult, *protocol.MethodArgumentArray, error) {
		_, err := h.handleSdkCall(contextId, native.SDK_OPERATION_NAME_ADDRESS, "getSignerAddress")
		fmt.Println(err)
...
func TestSdkAddress_GetSignerAddressDoesNotChangeWithContractCalls(t *testing.T) {
	...
	h.expectNativeContractMethodCalled("Contract1", "method1", func(contextId primitives.ExecutionContextId, inputArgs *protocol.MethodArgumentArray) (protocol.ExecutionResult, *protocol.MethodArgumentArray, error) {
		...
		res, err := h.handleSdkCall(contextId, native.SDK_OPERATION_NAME_ADDRESS, "getSignerAddress")
...
func TestSdkAddress_GetCallerAddressWithoutSignerFails(t *testing.T) {
	...
	h.expectStateStorageBlockHeightRequested(12)
	h.expectNativeContractMethodCalled("Contract1", "method1", func(contextId primitives.ExecutionContextId, inputArgs *protocol.MethodArgumentArray) (protocol.ExecutionResult, *protocol.MethodArgumentArray, error) {
		_, err := h.handleSdkCall(contextId, native.SDK_OPERATION_NAME_ADDRESS, "getCallerAddress")
		fmt.Println(err)
		require.Error(t, err, "handleSdkCall should fail since not signed")
		return protocol.EXECUTION_RESULT_SUCCESS, builders.MethodArgumentsArray(), nil
	})
...
func TestSdkAddress_GetCallerAddressChangesWithContractCalls(t *testing.T) {
	...
	h.expectNativeContractMethodCalled("Contract1", "method1", func(contextId primitives.ExecutionContextId, inputArgs *protocol.MethodArgumentArray) (protocol.ExecutionResult, *protocol.MethodArgumentArray, error) {
		...
		res, err := h.handleSdkCall(contextId, native.SDK_OPERATION_NAME_ADDRESS, "getCallerAddress")
		require.NoError(t, err, "handleSdkCall should succeed")
		...
		_, err = h.handleSdkCall(contextId, native.SDK_OPERATION_NAME_SERVICE, "callMethod", "Contract4", "method1", builders.MethodArgumentsArray().Raw())
		require.NoError(t, err, "handleSdkCall should succeed")
	...
	h.expectNativeContractMethodCalled("Contract2", "method1", func(contextId primitives.ExecutionContextId, inputArgs *protocol.MethodArgumentArray) (protocol.ExecutionResult, *protocol.MethodArgumentArray, error) {
		...
		_, err = h.handleSdkCall(contextId, native.SDK_OPERATION_NAME_SERVICE, "callMethod", "Contract3", "method1", builders.MethodArgumentsArray().Raw())
		require.NoError(t, err, "handleSdkCall should succeed")

		return protocol.EXECUTION_RESULT_SUCCESS, builders.MethodArgumentsArray(), nil
	})
	h.expectNativeContractMethodCalled("Contract3", "method1", func(contextId primitives.ExecutionContextId, inputArgs *protocol.MethodArgumentArray) (protocol.ExecutionResult, *protocol.MethodArgumentArray, error) {
	...
	h.expectNativeContractMethodCalled("Contract4", "method1", func(contextId primitives.ExecutionContextId, inputArgs *protocol.MethodArgumentArray) (protocol.ExecutionResult, *protocol.MethodArgumentArray, error) {
