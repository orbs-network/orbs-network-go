...
func (c *blockSyncConfigForTests) CommitteeGracePeriod() time.Duration {
...
func newDefaultBlockSyncConfigForTests() *blockSyncConfigForTests {
	return &blockSyncConfigForTests{
		...
		committeeGracePeriod: 100 * time.Second,
...
func (h *blockSyncHarness) withCommitteeGracePeriod(d time.Duration) *blockSyncHarness {
	h.config.committeeGracePeriod = d
	return h
}
