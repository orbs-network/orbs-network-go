...
func (s *idleHeadersState) name() string {
	return "idle-headers-state"
}

func (s *idleHeadersState) String() string {
	return s.name()
}

func (s *idleHeadersState) processState(ctx context.Context) headerSyncState {
	start := time.Now()
