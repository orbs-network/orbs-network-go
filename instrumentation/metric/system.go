...
func NewSystemReporter(ctx context.Context, metricFactory Factory, logger log.Logger) *govnr.ForeverHandle {
	r := &systemReporter{
		metrics: systemMetrics{
...
func (r *systemReporter) startReporting(ctx context.Context, logger log.Logger) *govnr.ForeverHandle {
...
func (r *systemReporter) reportSystemMetrics(logger log.Logger) {
