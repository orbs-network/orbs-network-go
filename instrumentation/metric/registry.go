...
type Registry interface {
	...
	PeriodicallyRotate(ctx context.Context, logger log.Logger) *govnr.ForeverHandle
...
func (r *inMemoryRegistry) PeriodicallyRotate(ctx context.Context, logger log.Logger) *govnr.ForeverHandle {
