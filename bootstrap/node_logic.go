...
func NewNodeLogic(
	...
	ipfsService := ipfs.NewIPFS(nodeConfig, logger)
	virtualMachineService := virtualmachine.NewVirtualMachine(stateStorageService, processors, crosschainConnectors, logger, ipfsService)
