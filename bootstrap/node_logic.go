...
func NewNodeLogic(parentCtx context.Context,
	...
	blockStorageService := blockstorage.NewBlockStorage(ctx, nodeConfig, blockPersistence, gossipService, gossipService, logger, metricRegistry, serviceSyncCommitters)
