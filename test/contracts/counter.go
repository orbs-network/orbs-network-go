...
const COUNTER_NATIVE_SOURCE_CODE_PART_1 = `
package main
...
const COUNTER_NATIVE_SOURCE_CODE_PART_2 = `
package main
...
func NativeSourceCodeForCounterPart1(startFrom uint64) []byte {
	return []byte(fmt.Sprintf(COUNTER_NATIVE_SOURCE_CODE_PART_1, startFrom))
}

func NativeSourceCodeForCounterPart2(startFrom uint64) []byte {
	return []byte(COUNTER_NATIVE_SOURCE_CODE_PART_2)
}
