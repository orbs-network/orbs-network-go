...
const (
	...
	CONSENSUS_CONTEXT_PERCENTAGE_OF_NODES_REQUIRED_FOR_CONSENSUS = "CONSENSUS_CONTEXT_PERCENTAGE_OF_NODES_REQUIRED_FOR_CONSENSUS"
...
func (c *config) ConsensusContextPercentageOfNodesRequiredForConsensus() uint32 {
	return c.kv[CONSENSUS_CONTEXT_PERCENTAGE_OF_NODES_REQUIRED_FOR_CONSENSUS].Uint32Value
}
