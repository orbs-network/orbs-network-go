...
const (
	...
	COMMITTEE_VALIDITY_TIMEOUT         = "COMMITTEE_VALIDITY_TIMEOUT"
...
func (c *config) CommitteeValidityTimeout() time.Duration {
	return c.kv[COMMITTEE_VALIDITY_TIMEOUT].DurationValue
}
