...
func ForAcceptanceTestNetwork(
	...
	cfg.SetDuration(LEAN_HELIX_CONSENSUS_ROUND_TIMEOUT_INTERVAL, 100*time.Millisecond) // If this is lower than node-sync interval, then node-sync will be triggered unnecessarily
