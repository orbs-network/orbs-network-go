...
require (
	...
	github.com/orbs-network/govnr v0.1.0
	github.com/orbs-network/lean-helix-go v0.1.0
	github.com/orbs-network/membuffers v0.3.0
	github.com/orbs-network/orbs-client-sdk-go v0.6.2
	github.com/orbs-network/orbs-contract-sdk v1.0.0
	github.com/orbs-network/orbs-spec v0.0.0-20190702065947-c6cfaf7cd01a
