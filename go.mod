...
require (
	...
	github.com/orbs-network/healthcheck v1.1.0 // indirect
	github.com/orbs-network/lean-helix-go v0.3.1
	...
	github.com/orbs-network/orbs-spec v0.0.0-20200617110800-c4c556472ce9
